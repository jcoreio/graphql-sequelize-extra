...
export default class Product extends Model<ProductAttributes, ProductInitAttributes> {
  id: number;
  name: string;
  weight: number;
  WarehouseId: ?number;
  ...
  static Barcode: Association.HasOne<Product, BarcodeAttributes, BarcodeInitAttributes, Barcode> = (null: any)

  getBarcode: HasOneGetOne<Barcode>
  setBarcode: HasOneSetOne<Barcode, number>
  createBarcode: HasOneCreateOne<BarcodeInitAttributes>

  static Warehouse: Association.BelongsTo<Product, WarehouseAttributes, WarehouseInitAttributes, Warehouse> = (null: any)
