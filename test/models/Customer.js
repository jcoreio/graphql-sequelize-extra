...
export default class Customer extends Model<CustomerAttributes, CustomerInitAttributes> {
  firstName: string;
  lastName: string;
  id: number;
  address: ?string;
  ...
  static Branches: Association.BelongsToMany<CustomerAttributes,
  ...
  setBranches: BelongsToManySetMany<Branch, number, BranchCustomerInitAttributes>
  addBranches: BelongsToManyAddMany<Branch, number, BranchCustomerInitAttributes>
  addBranch: BelongsToManyAddOne<Branch, number, BranchCustomerInitAttributes>
  createBranch: BelongsToManyCreateOne<BranchInitAttributes, Branch, BranchCustomerInitAttributes>
