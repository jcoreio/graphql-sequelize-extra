...
> {
  ...
  static Customers: Association.BelongsToMany<
    BranchAttributes,
    BranchInitAttributes,
    Branch,
    CustomerAttributes,
  ...
  setCustomers: BelongsToManySetMany<
    Customer,
    number,
    BranchCustomerInitAttributes
  >
  addCustomers: BelongsToManyAddMany<
    Customer,
    number,
    BranchCustomerInitAttributes
  >
  addCustomer: BelongsToManyAddOne<
    Customer,
    number,
    BranchCustomerInitAttributes
  >
